...
hpt = (
    hypertune.HyperTune()
)  # TODO: instantiate the cloudml_hyper Hyper reporting object
...
class HPTCallback(tf.keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        global hpt
        # TODO:Inside the on_epoch_end function of the Keras Callback,
        # set up cloudml-hypertune to report the results of each trial by calling
        # its helper function, `report_hyperparameter_tuning_metric`, and define the
        # hyperparameter tuning metric using its `metric_value` parameter
